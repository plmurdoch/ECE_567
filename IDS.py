...
def Training_Testing_Model(file, output_name):
    ...
    Machine = KNeighborsClassifier(n_neighbors = 7) #7 good approximation without over fitting most accurate for KNN with most reliable accuracy 97% with inf and nan entities dropped
